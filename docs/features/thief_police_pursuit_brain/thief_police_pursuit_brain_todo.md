...
## Feature: Thief Local Police Pursuit Brain Simulator (`thief_police_pursuit_brain`)

This task list tracks the implementation progress for `thief_police_pursuit_brain`.

### Task Breakdown & Progress Tracking

#### Phase 1: Setup & Interface Definition
- [x] Task 1.1: Define data structures, schemas, and constant definitions for `thief_police_pursuit_brain`.
- [x] Task 1.2: Create unit test file in `tests/test_thief_police_pursuit_brain.py`.
...
- [x] Feature verified against `thief_police_pursuit_brain_prd.md`.
