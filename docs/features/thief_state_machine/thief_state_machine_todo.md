...
## Feature: Thief Finite State Machine & Turn Transition Controller (`thief_state_machine`)

This task list tracks the implementation progress for `thief_state_machine`.

### Task Breakdown & Progress Tracking

#### Phase 1: Setup & Interface Definition
- [x] Task 1.1: Define data structures, schemas, and constant definitions for `thief_state_machine`.
- [x] Task 1.2: Create unit test file in `tests/test_thief_state_machine.py`.
...
- [x] Feature verified against `thief_state_machine_prd.md`.
