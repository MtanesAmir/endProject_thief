...
This development plan outlines the implementation of `thief_state_machine` based on the requirements defined in `thief_state_machine_prd.md`.

```mermaid
graph TD
    Orchestrator[Thief Orchestrator] --> FeatureModule[Thief Finite State Machine & Turn Transition Controller]
