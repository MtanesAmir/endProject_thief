...
This feature provides `thief_http_p2p_network_server` capabilities for the Thief agent in the distributed Cops-and-Robbers Dec-POMDP game over P2P FastMCP.
...
- **FR-01**: Implement core interface and data structures for `thief_http_p2p_network_server`.
