...
## Feature: Thief SHA-256 Commit-Reveal Cryptographic Protocol (`thief_commit_reveal_crypto`)

This task list tracks the implementation progress for `thief_commit_reveal_crypto`.

### Task Breakdown & Progress Tracking

#### Phase 1: Setup & Interface Definition
- [x] Task 1.1: Define data structures, schemas, and constant definitions for `thief_commit_reveal_crypto`.
- [x] Task 1.2: Create unit test file in `tests/test_thief_commit_reveal_crypto.py`.
...
- [x] Feature verified against `thief_commit_reveal_crypto_prd.md`.
