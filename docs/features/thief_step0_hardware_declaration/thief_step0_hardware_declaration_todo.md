...
## Feature: Thief Step-0 Hardware Auto-Discovery Declaration (`thief_step0_hardware_declaration`)

This task list tracks the implementation progress for `thief_step0_hardware_declaration`.

### Task Breakdown & Progress Tracking

#### Phase 1: Setup & Interface Definition
- [x] Task 1.1: Define data structures, schemas, and constant definitions for `thief_step0_hardware_declaration`.
- [x] Task 1.2: Create unit test file in `tests/test_thief_step0_hardware_declaration.py`.
...
- [x] Feature verified against `thief_step0_hardware_declaration_prd.md`.
