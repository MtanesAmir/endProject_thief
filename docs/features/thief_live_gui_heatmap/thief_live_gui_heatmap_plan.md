...
## Feature: Thief Live GUI Heatmap & Turn Observer Banner (`thief_live_gui_heatmap`)

### 1. Technical Architecture & Component Design
This development plan outlines the implementation of `thief_live_gui_heatmap` based on the requirements defined in `thief_live_gui_heatmap_prd.md`.

```mermaid
graph TD
    Orchestrator[Thief Orchestrator] --> FeatureModule[Thief Live GUI Heatmap & Turn Observer Banner]
