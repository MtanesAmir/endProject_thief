...
## Feature: Thief Base Grid & Movement Engine (`thief_base_grid_movement`)

### 1. Product Overview & Problem Statement
This feature provides `thief_base_grid_movement` capabilities for the Thief agent in the distributed Cops-and-Robbers Dec-POMDP game over P2P FastMCP.
...
- **FR-01**: Implement core interface and data structures for `thief_base_grid_movement`.
