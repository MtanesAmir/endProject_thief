...
## Feature: Thief Evasion & Capture Verification Mechanics (`thief_capture_mechanics`)

This task list tracks the implementation progress for `thief_capture_mechanics`.

### Task Breakdown & Progress Tracking

#### Phase 1: Setup & Interface Definition
- [x] Task 1.1: Define data structures, schemas, and constant definitions for `thief_capture_mechanics`.
- [x] Task 1.2: Create unit test file in `tests/test_thief_capture_mechanics.py`.
...
- [x] Feature verified against `thief_capture_mechanics_prd.md`.
