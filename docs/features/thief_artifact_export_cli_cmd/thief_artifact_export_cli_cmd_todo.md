...
## Feature: Thief Match Artifact Export CLI Subcommand (`thief_artifact_export_cli_cmd`)

This task list tracks the implementation progress for `thief_artifact_export_cli_cmd`.

### Task Breakdown & Progress Tracking

#### Phase 1: Setup & Interface Definition
- [x] Task 1.1: Define data structures, schemas, and constant definitions for `thief_artifact_export_cli_cmd`.
- [x] Task 1.2: Create unit test file in `tests/test_thief_artifact_export_cli_cmd.py`.
...
- [x] Feature verified against `thief_artifact_export_cli_cmd_prd.md`.
